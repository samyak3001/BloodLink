...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Emergency Crimson: For urgent requests, alerts, critical states
        emergency: {
          50: '#FEF2F2',
          100: '#FEE2E2',
          200: '#FECACA',
        ...
        // Clinical Trust Blue: For navigation, hospitals, verified badges, action buttons
        clinical: {
          50: '#F0F9FF',
          100: '#E0F2FE',
          200: '#BAE6FD',
        ...
        // Vitality Emerald: For available status, successful donations, fulfilled badges
        vitality: {
          50: '#ECFDF5',
          100: '#D1FAE5',
          200: '#A7F3D0',
